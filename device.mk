...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ueventd.hardware.rc:$(TARGET_COPY_OUT_VENDOR)/etc/ueventd.rc \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.hardware.diag.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.$(PRODUCT_HARDWARE).diag.rc
